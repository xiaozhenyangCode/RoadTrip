...
- (MAAnnotationView *)mapView:(MAMapView *)mapView viewForAnnotation:(id<MAAnnotation>)annotation{
    ...
    if ([annotation isKindOfClass:[MAPointAnnotation class]]) {
        ...
        if (self.currentRecord.numOfLocations) {
            if (annotation.coordinate.latitude == self.currentRecord.coordinates[self.currentRecord.numOfLocations-1].latitude
                && annotation.coordinate.longitude == self.currentRecord.coordinates[self.currentRecord.numOfLocations-1].longitude)
            {
