...
#import "UIColor+RTCategory.h"

@implementation UIColor (RTCategory)
...
{
    NSArray *colorArray = @[@"#6ea3ff",@"#fea646",@"#59cbf4",@"ec6d7a",@"#62d5ba"];
    int value = arc4random() % 4;
    NSString *colorString = colorArray[value];
